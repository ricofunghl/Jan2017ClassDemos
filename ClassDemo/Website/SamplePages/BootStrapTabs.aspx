        ...
        <div class="col-md-12">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="home">
                    <p>This is an example of using css tabs. Each tab is created in the nav tab area. 
                        It is assigned a href value to identify the tab pane.</p>
                    <p>
                        Although only one pane will be viewed at a time
                        all panes are loaded with their data.
                        You have access to all controls on all panes at all time
                    </p>
                </div>
                 <div role="tabpanel" class="tab-pane" id="artists">
                     ...
                     <asp:ObjectDataSource ID="ArtistListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Artist_ListAll" TypeName="ChinookSystem.BLL.ArtistController"></asp:ObjectDataSource>
                </div>
                 <div role="tabpanel" class="tab-pane" id="albums">
                         ...
                         <ItemTemplate>
                             <tr style="">
                                 ...
                                 <td>
                                     ...
                                     <%--<asp:Label Text='<%# Eval("Albums") %>' runat="server" ID="AlbumsLabel" /></td>--%>
                             </tr>
                         </ItemTemplate>
                         <LayoutTemplate>
                             <table runat="server">
                     ...
                     <asp:ObjectDataSource ID="AlbumListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ArtistAlbumReleases_List" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
                </div>
            </div>
        </div>
    </div>
