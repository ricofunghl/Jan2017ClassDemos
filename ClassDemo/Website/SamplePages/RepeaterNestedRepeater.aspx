...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <%--<!-- Inside a repeater you need as a minimum an ItemTemplate
        ...
        object instance referencing(instance.property) for fields instead of Eval("xxx") referencing--!>--%>
    <div class="col-sm-6">
        ...
        <asp:Repeater ID="ArtistAlbumReleasesListB" runat="server" DataSourceID="ArtistAlbumReleasesODS" 
            ...
            <ItemTemplate>
                ...
                <asp:Repeater ID="Albums" runat="server" DataSource='<%# Item.Albums %>' ItemType="Chinook.Data.POCOs.AlbumRelease">
                    <HeaderTemplate>
                        <table>
                            <tr>
                                <th>Year</th>
    ...
    <asp:ObjectDataSource ID="ArtistAlbumReleasesODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="ArtistAlbumReleases_List" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
</asp:Content>
